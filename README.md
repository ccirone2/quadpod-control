...
standing presets in `PRESETS`, both in `js/tabs/pose.js`. Conventions: sentence-case player words for labels (developer details only when `ctx.dev`), `store.get/set`
